          ...
          {showGoalOverlay && (
            ...
            >
              <svg viewBox="0 0 715 200" className="w-full max-w-4xl drop-shadow-2xl px-8">
                {/* Transparent handwritten text path */}
                <motion.path
                  fill="none"
                  stroke="#fbbf24"
                  strokeWidth="6"
